 ...
 * in the main to test.
 * 
 * This class was modified to comment out all the calls to 
 * assignment methods that resided in the Picture class
 * in the original College Board version. The necessary 
 * assignment methods have now been moved to the Helpers, 
 * PointProcesses, and EdgeDetection classes. Therefore
 * this class will not longer be used for testing.
 * Use the PixLabDriver class instead.
 * 
